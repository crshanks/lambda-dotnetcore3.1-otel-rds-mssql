# lambda-dotnetcore3.1-otel-rds-mssql
...
```bash
lambda-dotnetcore3.1-otel-rds-mssql$ sam build
```
...
```bash
lambda-dotnetcore3.1-otel-rds-mssql$ sam local invoke HelloWorldFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
lambda-dotnetcore3.1-otel-rds-mssql$ sam local start-api
lambda-dotnetcore3.1-otel-rds-mssql$ curl http://localhost:3000/
```
...
```bash
lambda-dotnetcore3.1-otel-rds-mssql$ sam logs -n HelloWorldFunction --stack-name lambda-dotnetcore3.1-otel-rds-mssql --tail
```
...
```bash
lambda-dotnetcore3.1-otel-rds-mssql$ dotnet test test/HelloWorld.Test
```
...
```bash
aws cloudformation delete-stack --stack-name lambda-dotnetcore3.1-otel-rds-mssql
```
